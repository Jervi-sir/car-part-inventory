...
// =============================================================================================================
// file: app/admin/vehicle-brands/page.tsx
"use client";
...
export default function VehicleBrandsPage() {
  ...
  const [editingId, setEditingId] = useState<Id3 | null>(null);
  ...
  return (
    <AdminLayout>
      ...
      <div className="p-6 space-y-4">
        ...
        <NameDialog open={open} onOpenChange={setOpen} title={editingId == null ? "New Brand" : "Edit Brand"} initialName={initialName} onSave={save} />
      </div>
    </AdminLayout>
  );
}
