    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-neutral-50 to-white dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 text-neutral-900 dark:text-neutral-100">
      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-3 text-xs text-neutral-500 dark:text-neutral-400">No credit card required. Approval usually same day.</p>
          </div>
      ...
      <section className="py-10">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6">
            <Link href={route("register")}>
              <Button size="lg" className="rounded-xl">Create account to continue</Button>
            </Link>
          </div>
        </div>
      </section>
